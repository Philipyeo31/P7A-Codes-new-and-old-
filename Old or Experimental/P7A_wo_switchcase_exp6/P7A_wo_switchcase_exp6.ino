...
void Step3()
{
  ...
  delay(2500);
  Serial.println("{p1:run,7}");//push remaining 1ml into reactor (og value is 30, 4.5)now 7 bc when p1 got error, it rotates 7 times gives us 950ul
...
void Step4()
{
  ...
  Serial.println("{p2:setspeed,-50}");
  delay(2500);
  Serial.println("{p2:run,2}");//loads 300microL into the reactor (1.91 original value, 2.35)
  delay(10000); 
...
void Step5()
{
  ...
  tft.setTextSize(2);
  tft.println("instantaneous reading is: ");
  averageReading = totalReading / 20.0;

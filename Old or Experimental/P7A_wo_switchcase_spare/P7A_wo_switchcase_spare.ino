...
void Step3()
{
  ...
  delay(2500);
  Serial.println("{p1:run,95.9}");//remove 18ml into waste from impinger
  delay(129000);
  Serial.println("{v1:off,A3}");//off waste
  delay(3000);
  Serial.println("{v1:on,A4}");//open reactor
  delay(2500);
  Serial.println("{p1:run,30}");//push remaining 1ml into reactor
  delay(40000);
  Serial.println("{v1:off,A4}");//off reactor
  delay(2500);
  Serial.println("{v1:on,A3}");//open waste
  delay(2500);
  Serial.println("{p1:run,5}");//remove exccess luquid
  delay(7000);
...
void Step4()
{
  ...
  delay(2500);
  Serial.println("{p2:run,5}");//loads 300microL into the reactor (1.91 original value)
  delay(10000);

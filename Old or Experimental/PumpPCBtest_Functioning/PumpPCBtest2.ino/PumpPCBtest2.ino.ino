...
byte example[] = {0xE9, 0x01, 0x06, 0x57, 0x4A, 0x01, 0xF4, 0x01, 0x01, 0xEF};
bool x = 0;
byte sendToPump[] = {};
...
void pump(int address, int speed /*RPM in units of 0.1. e.g 60.0RPM is 600*/, float revolutions, bool direction){
  ...
  */
  ...
  runDurationms = revolutions / speed * 600000; //6,000 instead of 60,000 is because speed is in units of 0.1 revolutions per minute
